...
- Use \`vista dashboard\` for net worth/summary, \`vista accounts\` for balances, \`vista holdings\` for investments, and \`vista transactions --limit N\` for recent activity.
- If Vista is not initialized, run \`vista init\`. Connect Plaid only when the user asks.
